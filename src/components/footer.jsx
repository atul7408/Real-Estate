...
<footer class="bg-black text-white">
 ...
 <img src="https://img.freepik.com/premium-vector/luxurious-real-estate-logo_42581-186.jpg"  className="w-10 h-10" alt='logo'/ >
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold uppercase dark:text-white">Home</h2>
                  <ul class=" dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Project</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" class="hover:underline">Feature</a>
                      </li>
                  </ul>
              </div>
              <div>
